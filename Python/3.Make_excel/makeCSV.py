...
# Write to CSV 
file_path = "jungle_story_prompts.csv"
with open(file_path, mode='w', newline='', encoding='utf-8-sig') as file:  # Changed to utf-8-sig to ensure ' gets inserted
    writer = csv.writer(file, quoting=csv.QUOTE_ALL)
    writer.writerows([[prompt] for prompt in prompts])  # Single write operation